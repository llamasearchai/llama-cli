...
def api_generate(
    language: str = typer.Argument(
        ..., help="Programming language (python, javascript, etc.)"
    ),
    output: str = typer.Option("./client", "--output", "-o", help="Output directory"),
    ...
    """
    print_warning(
        "API client generation functionality is not implemented in this version"
    )
    print_warning("This is a placeholder command")
